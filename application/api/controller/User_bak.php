...
class User_bak extends Api
{
    ...
    function signCheck($signArr)
    {
        $signArr['noncestr'] = config('Important.nonceStr'); //签名随机字符串
        ksort($signArr);//按照键名进行升序排序
        $str = '';
